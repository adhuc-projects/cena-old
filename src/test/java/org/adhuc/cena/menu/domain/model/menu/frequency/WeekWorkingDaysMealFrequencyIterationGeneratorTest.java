...
public class WeekWorkingDaysMealFrequencyIterationGeneratorTest {
    ...
    public void generateIterations1WorkingDay() {
        assertThat(generator.generateIterations(new GenerateMenus(CLOCK, 1, MENU_2017_01_02_START_DATE,
                MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_02_OWNER))).containsExactly(DINNER_2017_01_02_ID);
    }
    ...
    public void generateIterationsWeek() {
        assertThat(generator.generateIterations(new GenerateMenus(CLOCK, 7, MENU_2017_01_01_START_DATE,
                MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_01_OWNER))).containsExactly(LUNCH_2017_01_01_ID,
                        DINNER_2017_01_01_ID, DINNER_2017_01_02_ID, DINNER_2017_01_03_ID, DINNER_2017_01_04_ID,
                        DINNER_2017_01_05_ID, DINNER_2017_01_06_ID, LUNCH_2017_01_07_ID, DINNER_2017_01_07_ID);
    }
    ...
    public void determineIterationForUnknownMenuBeforeIterations() {
        assertThrows(IllegalArgumentException.class,
                () -> generator.determineIteration(DINNER_2017_01_01_ID, new GenerateMenus(CLOCK, 1,
                        MENU_2017_01_02_START_DATE, MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_02_OWNER)));
    }
    ...
    public void determineIterationForUnknownMenuAfterIterations() {
        assertThrows(IllegalArgumentException.class,
                () -> generator.determineIteration(DINNER_2017_01_03_ID, new GenerateMenus(CLOCK, 1,
                        MENU_2017_01_02_START_DATE, MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_02_OWNER)));
    }
    ...
    public void determineFirstMenuIteration1WorkingDay() {
        assertThat(generator.determineIteration(DINNER_2017_01_02_ID, new GenerateMenus(CLOCK, 1,
                MENU_2017_01_02_START_DATE, MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_02_OWNER))).isEqualTo(1);
    }

    @Test
    @DisplayName("determines iteration for 3rd menu during 5 working days")
    public void determineThirdMenuIteration5WorkingDays() {
        assertThat(generator.determineIteration(DINNER_2017_01_04_ID, new GenerateMenus(CLOCK, 5,
                MENU_2017_01_02_START_DATE, MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_02_OWNER))).isEqualTo(3);
    }
    ...
    public void determineLastMenuIteration5WorkingDays() {
        assertThat(generator.determineIteration(DINNER_2017_01_06_ID, new GenerateMenus(CLOCK, 5,
                MENU_2017_01_02_START_DATE, MealFrequency.WEEK_WORKING_DAYS, MENU_2017_01_02_OWNER))).isEqualTo(5);
    }
