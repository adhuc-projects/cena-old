...
public class WeekWorkingDaysMealFrequencyIterationGeneratorTest {
    ...
    public void generateIterations5WorkingDays() {
        assertThat(generator.generateIterations(
                new GenerateMenus(CLOCK, 5, LocalDate.parse("2017-01-02"), MealFrequency.WEEK_WORKING_DAYS)))
                        .containsExactly(DINNER_2017_01_02_ID, DINNER_2017_01_03_ID, DINNER_2017_01_04_ID,
    ...
    public void generateIterationsWeek() {
        assertThat(generator.generateIterations(
                new GenerateMenus(CLOCK, 7, LocalDate.parse("2017-01-01"), MealFrequency.WEEK_WORKING_DAYS)))
                        .containsExactly(LUNCH_2017_01_01_ID, DINNER_2017_01_01_ID, DINNER_2017_01_02_ID,
