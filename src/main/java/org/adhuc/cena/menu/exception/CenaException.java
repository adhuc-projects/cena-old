...
public class CenaException extends RuntimeException implements CodifiedException {
     ...
     *            the detail message.
     */
    public CenaException(final String message) {
     ...
     *            the cause.
     */
    public CenaException(final Throwable cause) {
     ...
     *            the exception code.
     */
    public CenaException(final ExceptionCode code) {
     ...
     *            the cause.
     */
    public CenaException(final String message, final Throwable cause) {
     ...
     *            the exception code.
     */
    public CenaException(final String message, final ExceptionCode code) {
     ...
     *            the exception code.
     */
    public CenaException(final Throwable cause, final ExceptionCode code) {
     ...
     *            the exception code.
     */
    public CenaException(final String message, final Throwable cause, final ExceptionCode code) {
        super(message, cause);
